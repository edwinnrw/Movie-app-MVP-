...
public class PlayingFragment extends Fragment implements HomeContract.View {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState!=null){
            createRecyclerView((List<Movie>) savedInstanceState.getSerializable("listMovie"));
        }else{
            homePresenter.getMovieNow();
        }
    ...
    public void setMovies(List<Movie> movies) {
        ...
        saveInstanceState.putSerializable("listMovie", (Serializable) movies);
