...
public class MovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "edn.projek.made.movieapp.TOAST_ACTION";
    public static final String EXTRA_ITEM = "edn.projek.made.movieapp.EXTRA_ITEM";
